...
function loadMyData () {
    ...
    myRequest.open("GET", "https://raw.githubusercontent.com/biatoSalo/JSONandAJAXExerciseLearner/master/JSONandAJAXExerciseLearner/expensiveLuxuryCars.json", true);
    ...
    myRequest.onload = function() {
        ...
        if (myRequest.readyState == 4 && myRequest.status == 200) {
			...
			// Change type to "bar", "area", "spline", "pie",etc.
			     ...
			     type: cT,  // the type is now choose chart type options
			     dataPoints: [
